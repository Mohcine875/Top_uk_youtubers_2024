...
The Head of Marketing wants to identify the top YouTubers in 2024 to choose the best candidates for marketing campaigns for the rest of the year.

What is the ideal solution?

Create a dashboard providing insights into the top UK YouTubers in 2024, including:
...
This will help the marketing team make informed decisions about which YouTubers to collaborate with.

## User story 

As the Head of Marketing, I want to use a dashboard that analyzes YouTube channel data in the UK. This dashboard should help me identify top-performing channels based on metrics like subscriber base and average views, allowing me to make better decisions for effective marketing campaigns.
...
Data on top UK YouTubers in 2024, including:
...
These questions might evolve as the analysis progresses. 
...
What are your initial observations with this dataset?
    ...
    The dataset includes the necessary columns for analysis, so no additional data from the client is required.
    The first column contains channel IDs separated by "@", which needs to be cleaned.
    Some cells and headers are in a different language and need to be addressed.
    The dataset contains extra columns that should be removed.
